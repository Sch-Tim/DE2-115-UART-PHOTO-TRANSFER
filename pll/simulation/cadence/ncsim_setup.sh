...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pll_altpll_2.vho"            -work altpll_2       -cdslib ./cds_libs/altpll_2.cds.lib      
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pll_altpll_1.vho"            -work altpll_1       -cdslib ./cds_libs/altpll_1.cds.lib      
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pll_altpll_0.vho"            -work altpll_0       -cdslib ./cds_libs/altpll_0.cds.lib      
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll.vhd"                                                                                              
fi
